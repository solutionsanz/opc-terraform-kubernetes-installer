...
#dashboard, monitoring, & metrics..
  ...
  kubectl create -f heapster/deploy/kube-config/influxdb/grafana.yaml >>/tmp/noise.out
  kubectl create -f heapster/deploy/kube-config/influxdb/influxdb.yaml >>/tmp/noise.out
  kubectl create -f heapster/deploy/kube-config/influxdb/heapster.yaml >>/tmp/noise.out
